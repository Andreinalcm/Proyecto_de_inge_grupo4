...
public class Dashboard extends JFrame {
    ...
    public Dashboard(Usuario usuario) {
        ...
        this.controller = GestorDeEventos.getInstancia(repositorioEventos); // Usar getInstancia
        ...
        if (usuario.getRol().equals("Profesor") || usuario.getRol().equals("Apoyo")
            ...
            //String rutaMain = Main.class.getProtectionDomain().getCodeSource().getLocation().getPath();
            //System.out.println(rutaMain);
            //VentanaPublicaciones ventana = new VentanaPublicaciones(gestorPublicaciones, usuario);

            hacerPublicacionBtn.addActionListener(e -> {
                //VentanaCrearPublicacion ventana2 = new VentanaCrearPublicacion(gestorPublicaciones, usuario);
            ...
            misPublicacionesBtn.addActionListener(e -> {
                ...
                SwingUtilities.invokeLater(() -> new MisPublicaciones(gestorPublicaciones, usuario)); // Pasar la instancia del gestor
            });
        }
