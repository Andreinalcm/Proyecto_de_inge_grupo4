...
import main.View.gestionDeUsuario.EditarPerfilUI;
import main.View.gestionDeUsuario.EditarPerfilUIOLD;
...
public class Dashboard extends JFrame {
    ...
    public Dashboard(GestorDeEventos controller, Usuario usuario) {
        ...
        editarPerfilBtn.addActionListener(e -> {
            //SwingUtilities.invokeLater(() -> new EditarPerfilUI());
            SwingUtilities.invokeLater(() -> {
                //new EditarPerfilUI().setVisible(true);

                String usuario2 = JOptionPane.showInputDialog("Ingrese su nombre de usuario:");
                if (usuario != null && !usuario2.trim().isEmpty()) {
                    SwingUtilities.invokeLater(() -> {
                        new EditarPerfilUI(usuario2).setVisible(true);
                    });
                }
